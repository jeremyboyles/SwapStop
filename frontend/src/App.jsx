...
export default function App() {
  ...
  // Handler to add a new message (text and optional image)
  const handleSendMessage = (msg) => {
    setChatMessages((prev) => [
      ...prev,
      { text: msg.text || '', image: msg.image || null, sender: 'You' }
    ]);
  };
    ...
    <div>
      <header className="header">
        <nav className="nav">
          ...
          <button className="btn outline" style={{ marginLeft: 16 }} onClick={() => setShowChat((v) => !v)}>
